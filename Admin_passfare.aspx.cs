...
{
    public partial class admin_passfare : System.Web.UI.Page
    {
        ...
        public void data()
        {
            try
            {
                SqlDataAdapter adp = new SqlDataAdapter("select * from add_fare_pass", con);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = con;
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "insert into add_fare_pass values(@p1,@p2,@p3)";
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = con;
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "update add_fare_pass set amt=@p2 where id=@p1";
        ...
        protected void Button5_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = con;
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "delete from  add_fare_pass  where id=@p1";
            cmd.Parameters.AddWithValue("@p1", Convert.ToInt32(Label3.Text));
            cmd.ExecuteNonQuery();
            con.Close();
            Label4.Text = " Pass fare Deleted Successfully !!!";
            data();
        }
    }
}