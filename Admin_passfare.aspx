<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_passfare.aspx.cs" Inherits="Toll_System.admin_passfare" %>
...
<body>
        ...
        function digitKeyOnly(e) {
            ...
            return false;
             ...
             <asp:Panel ID="Panel1" runat="server" CssClass="a">
                 ...
                 <marquee direction = "right"><h4> Admin Pass Fare</h4></marquee>
         <table>
    <tr>
    ...
    <td>Amount :</td>
    <td>
        <asp:TextBox ID="TextBox1" runat="server" onkeypress="return digitKeyOnly(event)"></asp:TextBox>
    </td>
    </tr>
    <tr>
    <td>
  ...
  <td>
      <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></td>
        ...
        <asp:BoundField DataField="ptype" HeaderText="Pass Type" />
        ...
        <br />
            ...
            <asp:ModalPopupExtender ID="ModalPopupExtender1" runat="server"
                TargetControlID="label2" PopupControlID="panel2"  CancelControlID="Button4">
             </asp:ModalPopupExtender>
            <asp:Panel ID="Panel2" runat="server" BackColor="BurlyWood">
          <table>
          <tr>
          <td>ID :</td>
          <td>
