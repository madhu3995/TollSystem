<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="oprator_add_pass.aspx.cs" Inherits="Toll_System.oprator_add_pass" %>
...
<body>
    ...
    <td>
        ...
        <td>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" SetFocusOnError="true" ForeColor="Red" ErrorMessage="Enter the Customer Name"></asp:RequiredFieldValidator></td>
    </tr>
    <tr>
    <td>Mobile No :</td>
    <td>
    ...
    <td>
        ...
        <td>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Enter the Vehicle No" ControlToValidate="TextBox5" SetFocusOnError="true" ForeColor="Red"></asp:RequiredFieldValidator></td>
    </tr>
    <tr>
    <td>Vehicle Type :</td>
    <td>
    ...
    <td>
        ...
        <asp:ListItem>Quatarly</asp:ListItem>
        </asp:DropDownList>
    </td>
    </tr>
    <tr>
    ...
    <td>
        ...
        <asp:Label ID="Label3" runat="server" Text="Send Message Status"></asp:Label>
        </div>
